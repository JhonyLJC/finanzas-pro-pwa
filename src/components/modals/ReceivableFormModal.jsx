...
export default function ReceivableFormModal({
  ...
  // Ensure 'Otros' exists
  const allCategoriesSet = new Set([...categories, 'Otros']);
  const allCategories = [...allCategoriesSet].sort();
                    ...
                    <div>
                        ...
                        {formData.category === 'Otros' && (
                            <input
                                ...
                                className="w-full mt-2 p-3 text-sm bg-slate-50 dark:bg-black/30 border border-slate-200 dark:border-white/5 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none dark:text-white transition-colors dark:placeholder-slate-500 shadow-inner"
