...
export default function SubscriptionView({ user }) {
  const plans = [
    { name: 'Personal', price: '9.90', features: ['Registro manual de deudas', 'Visualización del calendario', 'Soporte por correo electrónico'] },
    { name: 'Negocio', price: '19.90', features: ['Hasta 5 usuarios', 'Roles de Admin/Empleado', 'Reportes en Excel', 'Soporte prioritario por WhatsApp'] },
    { name: 'Empresa', price: '29.90', features: ['Usuarios ilimitados', 'Rol de Contador', 'Notificaciones Automáticas', 'Soporte prioritario por WhatsApp'] }
  ];
